...
const TherapistDashboard = ({ user, onLogout }) => {
  ...
  const handleSubmitQuestion = async (e) => {
    ...
    try {
      ...
      await loadTests(); // refresh question count
    } catch (err) { setError(err.message || "Error"); } finally { setLoading(false); }
  };
    ...
    <div className="dashboard">
      ...
      <Container className="content-area">
        ...
        <div className="scoring-guide">
          ...
          <p style={{ fontSize: "0.875rem", color: "#555", marginBottom: "0.5rem" }}>{t("therapist_scoring_desc")}</p>
          <ul>
      ...
      <Modal show={showAddQuestionModal} onHide={() => setShowAddQuestionModal(false)} size="lg" centered>
        ...
        <Modal.Body>
          <Form onSubmit={handleSubmitQuestion}>
            ...
            <div className="mb-2" style={{ fontSize: "0.8rem", color: "#888" }}>
