...
def main():
    ...
    print("\n=== Creating default materials (as therapist) ===")
    default_materials = [
        {"title": "Понимание выгорания", "content": "Узнайте признаки выгорания и эффективные стратегии его предотвращения.\n\n## Что такое выгорание?\n\nВыгорание — это состояние хронического стресса, которое приводит к физическому и эмоциональному истощению, цинизму и чувству неэффективности.\n\n## Признаки выгорания\n\n- Постоянная усталость\n- Снижение мотивации\n- Раздражительность\n- Проблемы со сном\n- Снижение продуктивности\n\n## Профилактика\n\n1. Устанавливайте границы между работой и личной жизнью\n2. Регулярно отдыхайте\n3. Занимайтесь физической активностью\n4. Практикуйте техники релаксации"},
        {"title": "Гид по осознанности", "content": "Простые техники практики осознанности в повседневной жизни.\n\n## Что такое осознанность?\n\nОсознанность — это практика намеренного присутствия в текущем моменте без осуждения.\n\n## Техники\n\n- **Дыхательная медитация**: Сосредоточьтесь на дыхании в течение 5-10 минут\n- **Сканирование тела**: Последовательно обратите внимание на ощущения в каждой части тела\n- **Осознанная прогулка**: Гуляйте, обращая внимание на каждый шаг\n- **Осознанное питание**: Ешьте медленно, замечая вкус и текстуру пищи"},
        {"title": "Оптимизация сна", "content": "Научно обоснованные советы для улучшения качества сна.\n\n## Гигиена сна\n\n1. Ложитесь и вставайте в одно и то же время\n2. Создайте комфортную среду для сна (прохлада, темнота, тишина)\n3. Избегайте экранов за 1 час до сна\n4. Ограничьте кофеин после 14:00\n5. Регулярно занимайтесь спортом, но не перед сном\n\n## Что делать при бессоннице\n\n- Если не можете заснуть за 20 минут — встаньте и займитесь спокойным делом\n- Практикуйте технику 4-7-8 (вдох 4 сек, задержка 7 сек, выдох 8 сек)"},
        {"title": "Управление стрессом", "content": "Проверенные методы управления стрессом и развития устойчивости.\n\n## Стратегии управления стрессом\n\n- **Физическая активность**: Даже 20 минут ходьбы снижают уровень стресса\n- **Социальная поддержка**: Общайтесь с близкими людьми\n- **Тайм-менеджмент**: Планируйте дела и расставляйте приоритеты\n- **Релаксация**: Используйте прогрессивную мышечную релаксацию\n- **Позитивное мышление**: Практикуйте благодарность\n\n## Быстрые техники\n\n1. Глубокое дыхание (5 вдохов-выдохов)\n2. Счёт до 10\n3. Краткая прогулка на свежем воздухе"},
    ]

    for mat in default_materials:
        r = requests.post(f"{BASE}/materials", json=mat, headers=headers)
        if r.status_code == 200:
            print(f"  Created material: {mat['title']}")
        else:
            print(f"  Material '{mat['title']}' might already exist or error: {r.status_code}")
